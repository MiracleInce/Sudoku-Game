...
void initWithOtherBoard(int arr[9][9], int other[9][9]){
	int i, j;
	for(i=0 ; i<9 ; i++){
		for (j=0 ; j<9 ; j++){
			arr[i][j]= other[i][j];
...
void showBoards(int board1[9][9], int board2[9][9], int board3[9][9]){
	int i, j;
	for(i=0 ; i<9; i++){
...
bool isValidNumber(int arr[9][9], int row, int col, int number){
